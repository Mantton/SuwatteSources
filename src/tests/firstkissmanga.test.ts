...
import { Target } from "../runners/firstkissmanga";
import {
  ChapterDataSchema,
  ChapterSchema,
  ContentSchema,
...
describe("FirstKissManga Tests", () => {
  ...
  test("Reader", async () => {
    const chapterId = "https://1st-kissmanga.net/manga/gray-maid/chapter-2/";
