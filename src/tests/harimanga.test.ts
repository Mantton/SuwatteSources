...
import { Target } from "../runners/harimanga";
import {
  ChapterDataSchema,
  ChapterSchema,
  ContentSchema,
...
describe("HariManga Tests", () => {
  ...
  const id = "/manga/i-quit-the-heros-party/";
  ...
  test("Reader", async () => {
    const chapterId =
      "https://harimanga.com/manga/i-quit-the-heros-party/chapter-5/?style=list";
