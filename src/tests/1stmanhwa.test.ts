...
import { Target } from "../runners/1stmanhwa";
import {
  ChapterDataSchema,
  ChapterSchema,
  ContentSchema,
...
describe("1st Manhwa Tests", () => {
  ...
  const id = "/manga/originally-a-lady-with-one-line/";
  ...
  test("Reader", async () => {
    const chapterId =
      "https://1stmanhwa.com/manga/originally-a-lady-with-one-line/chapter-136/?style=list";
