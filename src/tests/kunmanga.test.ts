...
import { Target } from "../runners/kunmanga";
import {
  ChapterDataSchema,
  ChapterSchema,
  ContentSchema,
...
describe("Kun Manga Tests", () => {
  ...
  const id = "/manga/i-quit-the-hero-s-party/";
  ...
  test("Reader", async () => {
    const chapterId =
      "https://kunmanga.com/manga/i-quit-the-hero-s-party/chapter-9/?style=list";
