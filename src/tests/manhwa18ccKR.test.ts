...
import { Target } from "../runners/kr.manhwa18cc";
import {
  ChapterDataSchema,
  ChapterSchema,
  ContentSchema,
...
describe("Manhwa18cc (KR) Tests", () => {
  ...
  const id = "/webtoon/body-bind-raw";
  ...
  test("Reader", async () => {
    const contentId = "/webtoon/body-bind-raw";
    const chapterId = "/webtoon/body-bind-raw/chapter-24?style=list";
