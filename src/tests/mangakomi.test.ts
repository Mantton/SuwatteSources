...
import { Target } from "../runners/mangakomi";
import {
  ChapterDataSchema,
  ChapterSchema,
  ContentSchema,
...
describe("MangaKomi Tests", () => {
  ...
  const id = "/manga/the-fragrant-flower-blooms-with-dignity/";
  ...
  test("Reader", async () => {
    const chapterId =
      "https://mangakomi.io/manga/the-fragrant-flower-blooms-with-dignity/chapter-80/?style=list";
