...
import { Target } from "../runners/elitemanga";
import {
  ChapterDataSchema,
  ChapterSchema,
  ContentSchema,
...
describe("Elite Manga Tests", () => {
  ...
  const id = "/manga/legendary-blacksmiths-vengeance/";
  ...
  test("Reader", async () => {
    const chapterId =
      "https://www.elitemanga.org/manga/legendary-blacksmiths-vengeance/chapter-24/?style=list";
